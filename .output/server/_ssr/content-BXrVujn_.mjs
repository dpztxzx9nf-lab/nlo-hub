//#region node_modules/.nitro/vite/services/ssr/assets/content-BXrVujn_.js
var SERVER = {
	name: "NLO",
...
var JOIN_STEPS = {
	java: [
		...
		{
			title: "Add Server",
			detail: `Name it NLO. Address is ${SERVER.ip}.`
		},
		{
	...
	bedrock: [
		...
		{
			title: "Join",
			detail: "You land in the same world as Java. Crossplay is on."
		},
		{
...
var CHALLENGES = [
	{
		...
		detail: "Visit all four overworld border posts before reset.",
		reward: "80 prestige · 400 coins"
	},
	{
		cadence: "Daily",
		title: "Honest trade",
		detail: "Complete three player-to-player sales or AH listings.",
		reward: "60 prestige · 250 coins"
	},
	{
		cadence: "Weekly",
		title: "Show the plot",
		detail: "Buy or tend a creative-world plot and open it for visitors.",
		reward: "220 prestige · plot crate"
	},
	{
		cadence: "Weekly",
		title: "Claim a name",
		detail: "Turn in a funded bounty, or post one that gets claimed.",
		reward: "300 prestige"
	},
	{
		cadence: "Season",
		title: "Still standing",
		detail: "Keep a claimed base intact through two weekly raids.",
		reward: "Season title"
	},
	{
		cadence: "Season",
		title: "Top of the ledger",
		detail: "Finish Season One as the #1 player. $20 in value — one prize or a split.",
		reward: "$20 · cloak / skin / Minecoins / gift card"
	},
	{
		cadence: "Season",
		title: "Banner clan",
		detail: "The clan on top at season close. Every listed member is paid.",
		reward: "25,000 coins each"
	}
];
var PRIZES = [{
	place: "Top player",
...
//#endregion
export { NAV as a, SERVER as c, JOIN_STEPS as i, WORLD_PILLARS as l, COIN_PACKS as n, PRIZES as o, FEATURES as r, RULES as s, CHALLENGES as t };
