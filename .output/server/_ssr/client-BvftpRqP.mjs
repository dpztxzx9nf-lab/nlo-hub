...
//#region node_modules/.nitro/vite/services/ssr/assets/client-BvftpRqP.js
var client_BvftpRqP_exports = /* @__PURE__ */ __exportAll({
	i: () => signOut,
	n: () => client_exports,
	r: () => signIn,
	t: () => authClient
...
async function signIn(providerId, opts = {}) {
	...
	const popup = inLivePreview() ? openSignInPopup(providerId, callbackURL) : null;
...
*/
function openSignInPopup(providerId, callbackURL = "/account") {
	const url = `${window.location.origin}/auth/popup?providerId=${encodeURIComponent(providerId)}&callbackURL=${encodeURIComponent(callbackURL)}`;
...
//#endregion
export { signOut as i, client_BvftpRqP_exports as n, signIn as r, authClient as t };
